...
def main_worker(args):
    ...
    # Testando modelo
    corr, preds, actuals, sentence_from, sentence_to = test_roberta(testing_loader, model, args, tokenizer)
    ...
    df.to_csv(os.path.join(current_dir, f'val_predictions_roberta_lex_test.csv'), index=False)
